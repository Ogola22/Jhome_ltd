                        ...
                        <div class="propertiesList">
                            <article class="propertyRow">
                                <div class="info">
                                    <div class="imgThumbnail">
                                        <a href="properties-single1.html"><img src="https://via.placeholder.com/110x85"
                                                alt=""></a>
                                    </div>
                                    <div class="textBox">
                            ...
                            <article class="propertyRow">
                                <div class="info">
                                    ...
                                    <div class="textBox">
                                        <h4 class="fontNeuron"><a href="properties-single1.html">4 Bedroom New House For
                                                Sale</a></h4>
                                        <address><i class="fi flaticon-pin-1"></i>The Village, Jersey City, NJ 07302, USA
                                        </address>
                                        <div class="priceArea">
                            ...
                            <article class="propertyRow">
                                <div class="info">
                                    ...
                                    <div class="textBox">
                                        <h4 class="fontNeuron"><a href="properties-single1.html">Villa on Hollywood
                                                Boulevard</a></h4>
                                        <address><i class="fi flaticon-pin-1"></i>The Village, Jersey City, NJ 07302, USA
                                        </address>
                                        <div class="priceArea">
