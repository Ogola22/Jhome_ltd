            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p><i class="fa fa-check text-primary me-3"></i>Whether you are a first-time homebuyer, an experienced investor, or simply looking to upgrade to a larger home, we have the expertise and resources to help you achieve your real estate goals. Our extensive network of industry professionals and access to the latest market data means that we can provide you with accurate and up-to-date information to help you make informed decisions.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>At Jhomes Ltd, we believe that honesty, integrity, and transparency are the foundations of a successful real estate agency. We are committed to providing our clients with honest advice, transparent communication, and a personalized service that is tailored to their individual needs.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>We understand that every client is unique, which is why we take the time to listen to your needs, understand your goals and work with you to achieve the best possible outcome. Whether you are buying, selling, or investing in real estate, we are here to help you navigate the process and achieve your desired outcome.</p>
                        <p class="mb-4">Thank you for considering Jhomes Ltd for your real estate needs. We look forward to working with you and helping you achieve your real estate goals.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        ...
                                        <a href="#"><div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">View Property</div></a>
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">
                            ...
                            <div class="d-flex align-items-center">
                                <img class="img-fluid flex-shrink-0 rounded" src="../../src/assets/img/testimonial-1.jpg" style="width: 45px; height: 45px;">
                                <div class="ps-3">
                    ...
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">
                            <p>Tempor stet labore dolor clita stet diam amet ipsum dolor duo ipsum rebum stet dolor amet diam stet. Est stet ea lorem amet est kasd kasd erat eos</p>
                            <div class="d-flex align-items-center">
                                <img class="img-fluid flex-shrink-0 rounded" src="../../src/assets/img/testimonial-2.jpg" style="width: 45px; height: 45px;">
                                <div class="ps-3">
                                    <h6 class="fw-bold mb-1">Client Name</h6>
                                    <small>Profession</small>
                                </div>
                    ...
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">
                            <p>Tempor stet labore dolor clita stet diam amet ipsum dolor duo ipsum rebum stet dolor amet diam stet. Est stet ea lorem amet est kasd kasd erat eos</p>
                            <div class="d-flex align-items-center">
                                <img class="img-fluid flex-shrink-0 rounded" src="../../src/assets/img/testimonial-3.jpg" style="width: 45px; height: 45px;">
                                <div class="ps-3">
                                    <h6 class="fw-bold mb-1">Client Name</h6>
                                    <small>Profession</small>
                                </div>
