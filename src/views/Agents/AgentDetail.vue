            ...
            <div class="row">
                        ...
                        <div class="accountHolder">
                            <div class="imgProfile">
                                <div class="imgThumbnail">
                                    <img src="../../../src/assets/img/team-5.jpg" alt="image description">
                                </div>
                            </div>
                            <div class="accountContent">
                                <strong class="title fontNeuron">Brian Ogola</strong>
                                <span class="sub-title">Sales Agent</span>
                ...
                <div class="col-xs-12 col-sm-12 col-lg-4">
                    ...
                    <div class="contactFormPage">
                        <h4 class="fontNeuron">Contact Brian Ogola</h4>
                        <form>
                            <div class="row">
                                <div class="col-xs-12">
